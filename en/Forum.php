...
return [
    ...
    "create" => [
      ...
      "description" => "Create your forum for free with Cybricode",

      "success" => "The forum is successfully created!",

      "error__link" => "Oops... The custom link is not allowed by Cybricode.",
    ...
    "forums_description" => "Find all the forums created on Cybricode",

    "sponsored_forums" => "Sponsored forums",

    "sponsored_forums_description" => "Here is a list of sponsored forums on Cybricode.",
