...
return [
  ...
  'register_text' => "Create your Cybricode account today",

  'send' => "Send",

  'login__question' => "Do you already have a Cybricode account?",
  ...
  'error__notActivated' => "Oops, the Cybricode account is not active. If you think this is an error, contact us on the Discord. If you haven't checked your email, consider checking your spam.",

  'error__email_not_valided' => "Oops... Your email has not been validated.",

  'error__banned_user' => "Oops... Your account has been banned by Cybricode.",

  'error__closed_account' => "For a security reason, your account has been closed. Your email cannot be used again. Please contact us by email contact@cybricode.com to unblock your account.",
  ...
  'error__exist_account' => 'Sorry, but this account already exists on Cybricode',

  'error__no_exist_account' => 'Sorry, but this account does not exist. Please check your email.',



  'success_register' => "Successful registration! You can now login to your Cybricode account!",
