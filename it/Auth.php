...
return [
  ...
  'login_text' => "Connexion à votre compte",
  'login__success' => "Connexion réussie",
  'username' => "Pseudo",
  'email' => "Email",
  'password' => "Mot de passe",
  'confirm_password' => "Confirmer le mot de passe",
  'tos_check' => "J'accepte les conditions et la politique",
  ...
  'text__connected' => "Vous êtes connecté",
  ...
  'error__banned_caracters' => "Vous utilisez des caractères interdit. Veuillez changer votre pseudo.",
  ...
  'success__login' => "Connexion réussie",


  'update_text' => "Votre {0} vient d'être modifié avec succès.",
  'update__password_not_good' => "Le mot de passe de votre compte est incorrecte.",
  'password' => "mot de passe",
